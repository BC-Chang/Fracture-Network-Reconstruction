...
def coord_trans(data, v, k):
    ...
    def rotmat(l, m, n, angle): return [[l*l*(1-math.cos(angle))+math.cos(angle), m*l*(1-math.cos(angle))-n*math.sin(angle), n*l*(1-math.cos(angle))+m*math.sin(angle)],
                                        [l*m*(1-math.cos(angle))+n*math.sin(angle), m*m*(1-math.cos(angle)) +
                                         math.cos(angle), n*m*(1-math.cos(angle))-l*math.sin(angle)],
